...
public class BoxFormation : MonoBehaviour {
	...
	string[] enemies = new string[3] {"Grenadier/Grenadier","Cruiser/Cruiser","DogFighterA/DogFighterA"};
	...
	void SpawnEnemy (int enemyNumber) {
		...
		{
			GameObject dogfighter = Resources.Load<GameObject> ("Enemies/" + enemies[2]);
			...
			Instantiate(dogfighter, new Vector3(right * 1.2f, top/4, 0), Quaternion.identity);
			Instantiate(dogfighter, new Vector3(right * 1.2f, bottom/2, 0), Quaternion.identity);
			Instantiate(dogfighter, new Vector3(right * 1.2f, bottom/4, 0), Quaternion.identity);
		...
		else if(enemyNumber == 2)
		{
			...
			GameObject grenadier = Resources.Load<GameObject> ("Enemies/" + enemies[0]);

			Instantiate(grenadier, new Vector3(right * 1.2f, 0, 0), Quaternion.identity);

			GameObject cruiser = Resources.Load<GameObject> ("Enemies/" + enemies[1]);

			Instantiate(cruiser, new Vector3(right * 1.2f, top*3/4, 0), Quaternion.identity);
			Instantiate(cruiser, new Vector3(right * 1.2f, bottom*3/4, 0), Quaternion.identity);
		}
