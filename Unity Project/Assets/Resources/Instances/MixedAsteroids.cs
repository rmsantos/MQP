/* Module      : MixedAsteroids.cs
 * Author      : Ryan Santos
 * Email       : rmsantos@wpi.edu
 * Course      : IMGD MQP
 *
 * Description : This instance spawns a wave of mixed (small, medium, large) asteroids
 *
 * Date        : 2015/1/28
 *
 *
...
public class MixedAsteroids : MonoBehaviour {
	
	/* -- GLOBAL VARIABLES --------------------------------------------------- */
	
	//Enemies possible to spawn
	string[] enemies = new string[3] {"Asteroids/AsteroidSmall","Asteroids/AsteroidMedium","Asteroids/AsteroidLarge"};
